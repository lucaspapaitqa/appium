*** Settings ***
Documentation       Necessário ter um contato na tela de chats
...
${HEADER_TITLE_PT}            id=com.ikatec.digisac:id/header_text_Conversas
${HEADER_TITLE_EN}            id=com.ikatec.digisac:id/header_text_Chats
...
${TEXT_EMPTY_CHATS_PT}        xpath=//android.widget.TextView[contains(@text, 'Não existem chamados abertos')]
${TEXT_EMPTY_CHATS_EN}        xpath=//android.widget.TextView[contains(@text, 'There are no open tickets')]
#Modal
...
Present The Elements In Chats
    ...
    Wait Until Element Is Visible                   ${TEXT_EMPTY_CHATS_PT} 
    Clear Text                                      ${INPUT_SEARCH}
    Wait Until Page Does Not Contain Element        ${TEXT_EMPTY_CHATS_PT}
...
Chats Screen In Portuguese
    ...
    Click Element                                   id=com.android.permissioncontroller:id/permission_allow_button
    Wait Until Element Is Visible                   ${HEADER_TITLE_PT}               
    Element Should Contain Text                     ${HEADER_TITLE_PT}              Conversas                       
    Click Element                                   ${BTN_SEARCH}
    Wait Until Element Is Visible                   ${INPUT_SEARCH}
    ...
    Input Text                                      ${INPUT_SEARCH}                 XXXXXXX
    Wait Until Element Is Visible                   ${TEXT_EMPTY_CHATS_PT}
    Element Should Contain Text                     ${TEXT_EMPTY_CHATS_PT}          Não existem chamados abertos
    Clear Text                                      ${INPUT_SEARCH}
    Wait Until Page Does Not Contain Element        ${TEXT_EMPTY_CHATS_PT}
    Long Press                                      ${CARD_CONTACT}                 500
    Wait Until Element Is Visible                   ${MODAL_BUTTON}
...
Chats Screen In English
    ...
    Wait Until Element Is Visible                   id=com.android.permissioncontroller:id/permission_allow_button
    Click Element                                   id=com.android.permissioncontroller:id/permission_allow_button
    Wait Until Element Is Visible                   ${HEADER_TITLE_EN}               
    Element Should Contain Text                     ${HEADER_TITLE_EN}              Chats                       
    Click Element                                   ${BTN_SEARCH}
    Wait Until Element Is Visible                   ${INPUT_SEARCH}
    ...
    Wait Until Element Is Visible                   ${INPUT_SEARCH}
    Input Text                                      ${INPUT_SEARCH}                 XXXXXXX
    Wait Until Element Is Visible                   ${TEXT_EMPTY_CHATS_EN}
    Element Should Contain Text                     ${TEXT_EMPTY_CHATS_EN}          There are no open tickets
    Clear Text                                      ${INPUT_SEARCH}
    Wait Until Page Does Not Contain Element        ${TEXT_EMPTY_CHATS_EN}
    Long Press                                      ${CARD_CONTACT}                 500
    Wait Until Element Is Visible                   ${MODAL_BUTTON}
